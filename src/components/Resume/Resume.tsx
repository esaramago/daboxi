    ...
    <div className={props.className}>
      {
        ...
        <div className="l-stack l-stack">
          ...
          <div className="l-row l-row--large">
            <div>
              Despesas<br />
              <Value value={totalExpense} sign={true} style={{ color: 'var(--wa-color-secondary-50)' }} size="l"></Value><br />
            </div>
            <div>
              Receitas<br />
              <Value value={totalIncome} sign={true} style={{ color: 'var(--wa-color-success-50)' }} size="l"></Value><br />
            </div>
          </div>
